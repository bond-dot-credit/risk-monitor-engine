  ...
  if (store.getAgents().length === 0) {
        ...
        metadata: {
          ...
          verificationMethods: [
            ...
            },
            {
              ...
              details: {
                methodology:
                  "Gas optimization testing, execution time analysis",
    ...
    const events: ReputationEvent[] = [
      ...
      },
      {
        ...
        description:
          "Credit line increased from $500K to $750K due to performance",
        impact: 20,
        metadata: {
      ...
      },
      {
        ...
        description:
          "LTV ratio updated from 65% to 72% while maintaining risk profile",
        impact: 18,
        metadata: {
          previousValue: 65,
          newValue: 72,
