...
export default function DashboardPage() {
  return (
    <Layout
      ...
      title="Dashboard"
      subtitle="Credit Vault Management System"
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Current risk metrics across all vaults
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Latest vault operations and alerts
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3">
              {[
                { action: 'Vault Created', vault: 'ETH-USDC-001', time: '2 hours ago', status: 'success' },
                { action: 'LTV Alert', vault: 'BTC-USDT-003', time: '4 hours ago', status: 'warning' },
                { action: 'Collateral Added', vault: 'ETH-USDC-001', time: '6 hours ago', status: 'info' },
                { action: 'Debt Repaid', vault: 'BTC-USDT-003', time: '1 day ago', status: 'success' },
              ].map((item, index) => (
                <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium">{item.vault}</span>
                  </div>
